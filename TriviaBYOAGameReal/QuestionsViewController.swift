...
//arrays for questions
    let animalsArrayQ: [String] = ["What animal has the longest lifespan?","A newborn kangaroo is about the size of a...?","How many times can a hummingbird flap its wings per second?","What animal has the highest blood pressure?","How mnay noses do slugs have?"]
    ...
    override func viewDidLoad() {
        ...
        {
           print(question)
            // questionLabel.text = animalsArrayQ
        }
